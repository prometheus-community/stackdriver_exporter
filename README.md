...
| `monitoring.metrics-type-prefix`<br />`STACKDRIVER_EXPORTER_MONITORING_METRICS_TYPE_PREFIX` | Yes | | Google Stackdriver Monitoring Metrics Type prefix (see [available metrics][metrics-list]) |
